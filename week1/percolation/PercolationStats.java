...
public class PercolationStats {
    ...
    public PercolationStats(int n, int trails)
    {
        ...
        double [] results = new double[trails];
        int test_site_y;
        int test_site_x;
        ...
        confidenceLo_value = mean_value - (1.96*stddev_value)/Math.sqrt(trails);
        confidenceHi_value = mean_value + (1.96*stddev_value)/Math.sqrt(trails);
